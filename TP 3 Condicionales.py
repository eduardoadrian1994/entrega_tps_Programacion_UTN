...
"""
# edad = int(input("Introduce tu edad: "))
# if edad < 12: print("Usted pertenece a la categoría Niño/a")
# elif edad <= 12 and edad < 18: print("Usted pertenece a la categoría Adolescente")
# elif edad >= 18 and edad < 30:print("Usted pertenece a la categoría Adulto/a joven")
# elif edad >= 30:print("Usted pertenece a la categoría Adulto/a")
...
# if password.isalnum() and len(password) >= 8 and len(password) <= 14:
...
# print("La media es: ", mean(mi_lista))
# print("La mediana es: ", median(mi_lista))
# print("La moda es: ", mode(mi_lista))
""""
...
# if media > mediana:
#     print("Sesgo positivo (Distribución sesgada a la derecha).")
# elif media < mediana:
#     print("Sesgo negativo (Distribución sesgada a la izquierda).")
# else:
